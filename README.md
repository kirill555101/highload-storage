...
<!---
Просьба расписать методику расчета среднего кол-ва действий на юзера 
--->
...
<!---
Просьба добавить размерности в формулу чтобы было понятно какие значения в ней участвуют
--->
...
<!---
Просьба расписать методику расчета траффика на юзера 
--->
...
<!---
Уточнить это рпс пер юзер или тотал?
--->
