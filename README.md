...
На этом уровне располагается Frontend, на котором будет находиться Nginx для:
* Передачи статических файлов
* Балансировки на уровень Backend
...
### Уровень данных
На этом уровне располагается Database, на котором будет применяться:
* Реализация Master-Slave для репликации
* Шардирование по id файлов на Master
